...
using UnityEngine;
    ...
    public class CameraCollision : MonoBehaviour
    {
        ...
        private MainCamera m_Cam;                  // the point at withc the camera pivots around
        ...
        private void Start()
        {
            ...
            m_Cam = GetComponent<MainCamera>();
            m_OriginalDist = m_Cam.distance;
